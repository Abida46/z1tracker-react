  ...
  return (
    <div className="relative mt-10  border-neutral-800 min-h-[500px]">
      <div className="text-center">
        <h2 className="text-3xl sm:text-4xl lg:text-4xl mt-10lg:mt-20 tracking wide">
          <span className="bg-gradient-to-r from-blue-500 to-blue-800 text-transparent bg-clip-text">
            What makes us stand out?
          </span>
        </h2>
      </div>
      <div className="flex flex-wrap mt-5 lg:mt-10 w-full">
        {features.map((feature, index) => (
          <div key={index} className="w-full sm:1/2 lg:w-1/2">
            ...
            <h5 className="mt-1 mb-6 text-small">
              {feature.text}
